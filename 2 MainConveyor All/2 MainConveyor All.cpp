...
using namespace std;
ofstream logfile("my_log.txt", ios::app);
...
res finalvalue4(vector<state> &v1, vector<state> &v2, int **Jfactors, int n)
{
	...
	while ((i2 < v2.size()) && (i1 < v1.size()))
	{
		...
		if (v2[i2].isEqual(v1[i1]))//организуем суммирование
		{
