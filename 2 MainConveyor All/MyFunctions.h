...
//////////////////////////////////////////////////////////////////////////
extern double Vmatrix[SpinInPlaquet][3][MatrixSize][MatrixSize];//Номер вершины в плакете, тип матрицы SP,SM или SZ,номер ряда, номер столбца
extern double VmatrixInside[MatrixSize][MatrixSize];//Специально для внутренних воздействий
extern double Energie[MatrixSize]; //Энергии состояний
